 ...
 */
class admin_lieset_controller extends common{
	function index_action(){
		$this->yuntpl(array('admin/admin_integral_lie'));
	}
	...
	function set_action(){
		...
		$this->yuntpl(array('admin/admin_lie_config'));
	}

	function rating_action(){
		$qy_rows=$this->obj->DB_select_all("lietou_rating","`category`=1 order by sort desc");
		$this->yunset("qy_rows",$qy_rows);
		$this->yuntpl(array('admin/admin_lie_rating_config'));
	}
