 ...
 */
class lietou_recommend_controller extends common{
    function index_action(){
        ...
        if(is_array($list))
        {
            ...
            $member=$this->obj->DB_select_all("lietou","`uid` in (".@implode(",",$uid).")","name,uid");
            $resume=$this->obj->DB_select_all("resume_expect","id in (".@implode(",",$eid).")","uname,id");
        ...
        $this->yuntpl(array('admin/admin_lietou_recommend'));
    }
