  ...
  loadCitySelector:function(){
    this.each(function(index){
		...
		if(typeof(sLang)=="undefined" || sLang!="en") {
			var loadingTxt="加载中..", plsSelTxt=pl_parse?pl_parse:"请选择", maxSelTxt="最多可选择 ", maxUnitTxt=" 项", okTxt="确定", hadSelTxt="已选择", hotCityTxt="热门城市", allCityTxt="全国城市", maxSelNumTxt="最多可选择"+nMax+"项", errTxt="非常抱歉，加载数据失败，请刷新或稍后再尝试！";
			}
		else {
