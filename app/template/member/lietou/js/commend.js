...
$("body").on("click",".tuijan",function () {
    ...
    $("#tuijianbox #eid").val(_this.attr("data-eid"));
    $("#tuijianbox #job_id").val(GetQueryString('id'));
        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                if(data==1){
                    ...
                    layer.closeAll();
                    layer.msg('推荐成功！', 2, 9);
                    $("#"+"t_"+tj_id).removeClass("tuijan");
                    $("#"+"t_"+tj_id).addClass("yituijian");
                    $("#"+"t_"+tj_id).html("已推荐");
                }
            }
        })
