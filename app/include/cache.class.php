 ...
 */
 class cache{
	...
	public function user_cache($dir){
     ...
     public function department_cache($dir){
         $rows=$this->obj->DB_select_all("lieclass","1 order by sort asc");
         ...
         $data['dpdata']=ArrayToString($data2);
         $data['dpclass_name']=ArrayToString($jobname);
         return made_web_array($this->cachedir.$dir,$data);
     }
