    ...
    function RedLoginHead_action(){
        if($this->uid!=""&&$this->username!=""){
            ...
            if($_GET['f']=='l'){
                ...
                $html='<div class=" fr"><div class="yun_topLogin_cont"><div class="yun_topLogin denglu" style="width:100px;border-right: 1px solid #eee;"><a class="coloess"  href="http://www.zhanjob.com/index.html#/dologin" >�ڲ�ϵͳ���</a></div><div class="yun_topLogin" style="width:126px;padding-left: 5px;border-right: 1px solid #eee;"> <a class="coloess" href="'.$this->config['sy_ppingurl'].'">�Ϸ��»�OAϵͳ</a></div><div class="yun_topLogin denglu" style="width:90px;"><a class="coloess" href="http://lt.huiliewang.com">����ϵͳ</a></div></div></div>';
