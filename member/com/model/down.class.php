	...
	function index_action(){ 
		...
		if(is_array($rows)&&$rows){ 
			if(empty($resume)){
				...
				$resume=$this->obj->DB_select_alls("resume","resume_expect","a.uid=b.uid and a.`r_status`<>'2' and b.id in (".@implode(",",$eid).")","a.`name`,a.`uid`,a.`exp`,b.`minsalary`,b.`maxsalary`,b.`job_classid`,b.`height_status`,b.`resume_id`,b.`uname`,b.`id`");
			} 
