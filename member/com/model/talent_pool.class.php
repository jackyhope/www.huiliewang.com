...
//
		if(is_array($rows)){
			if(empty($resume)){
				...
				$resume=$this->obj->DB_select_alls("resume","resume_expect","a.id=b.id and a.`r_status`<>'2' and a.id in (".pylode(',',$uid).")","a.`name`,a.`id`,a.`sex`,a.`edu`,b.`job_classid`,a.`exp`,b.`minsalary`,b.`maxsalary`");
