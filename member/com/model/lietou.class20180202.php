        ...
        if(is_array($rows) && !empty($rows)){
            ...
            if(is_array($resume)){
                ...
                foreach($rows as $k=>$v){
                    ...
                    $resume = $this->obj->DB_select_once("resume","id=".$v['resume_id'],"`name`,`edu`,`uid`,`exp`");
                    $rows[$k]['name']=$resume['name'];
                    $rows[$k]['edu']=$userclass_name[$resume['edu']];
                    $rows[$k]['exp']=$userclass_name[$resume['exp']];
