<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-10-07 00:19:37
         compiled from "/home/wwwroot/www.huiliewang.com/app/template/member/user/index.htm" */ ?>
<?php /*%%SmartyHeaderCode:2756802075bb8e099ae1862-20996310%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0ff7f0b3f7006da7c2ef23248fb6cc99d025ceb3' => 
    array (
      0 => '/home/wwwroot/www.huiliewang.com/app/template/member/user/index.htm',
      1 => 1519433820,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2756802075bb8e099ae1862-20996310',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bb8e099c16c83_93790210',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bb8e099c16c83_93790210')) {function content_5bb8e099c16c83_93790210($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/home/wwwroot/www.huiliewang.com/app/include/libs/plugins/function.url.php';
...
<div class="yun_user_indexpay" style="display: none;">
...
<div class="yun_user_index_jobmsg_list" style="display: none;"><a href="index.php?c=msg"><div class="yun_user_index_jobmsg_list_n"><?php if ($_smarty_tpl->tpl_vars['yqnum']->value=='') {?>0<?php } else { ?><i class="member_Information_amount_n_c"><?php echo $_smarty_tpl->tpl_vars['yqnum']->value;?>
...
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['alist']->value['name'];?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['resume']->value) {?>
        <div class="member_index_resume_box" id="resumelist<?php echo $_smarty_tpl->tpl_vars['resume']->value['id'];?>
" >
        <div class="member_index_resume_t">
            <div class="member_index_resume_t_left">
                <div class="member_index_resume_t_name fltL">
                    ...
                    <div class="index_resume_my_n" id="show_resume" style="border: none;background: none;cursor: inherit;"> <?php echo $_smarty_tpl->tpl_vars['resume']->value['name'];?>
的简历 </div>
                    <div class="index_resume_my_ll">被浏览：<?php echo $_smarty_tpl->tpl_vars['resume']->value['hits'];?>
 次
                ...
                <div class="member_index_resume_t_wz fltL">
                    ...
                    <div class="member_index_resume_t_wzd"> <span class="member_index_resume_t_wz_b"> <em class="ember_index_resume_t_wz_c" style="width:<?php echo $_smarty_tpl->tpl_vars['resume']->value['integrity'];?>
%"></em> </span> <span class="member_index_resume_t_wz_n"><?php echo $_smarty_tpl->tpl_vars['resume']->value['integrity'];?>
%</span> </div>
                </div>
                <div class="member_index_resume_job fltL">

                    <span class="member_index_resume_t_name_l fltL">期望职位：</span><span class="member_index_resume_jobname"><?php echo $_smarty_tpl->tpl_vars['resume']->value['jobname'];?>
</span>
                    <span class="member_index_resume_jobxz">期望薪资：<?php echo $_smarty_tpl->tpl_vars['resume']->value['user_salary'];?>
</span>
                    <span class="member_index_resume_time">更新时间：<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['resume']->value['lastupdate'],"%Y-%m-%d %H:%M:%S");?>
</span></div>
...
')" class="member_index_resume_t_cz_bth member_index_resume_t_cz_bth_hover ">简历置顶</a>-->
...
" target="_blank" class="member_index_resume_t_cz_bth ">预览简历</a>
                <a onclick="layer_del('确定要刷新？', 'index.php?c=resume&act=refresh&id=<?php echo $_smarty_tpl->tpl_vars['resume']->value['id'];?>
');" href="javascript:void(0)" class="member_index_resume_t_cz_bth ">刷新简历</a>
            </div>
        </div>
        ...
        <div class="member_index_resume_msg">
            ...
            <div class="member_index_resume_msg_r">
                ...
                <?php if ($_smarty_tpl->tpl_vars['resume']->value['work']==0) {?><a href="index.php?c=expect&e=<?php echo $_smarty_tpl->tpl_vars['resume']->value['id'];?>
#work_upbox" class="member_index_resume_msg_a">+ 工作经历</a><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['resume']->value['edu']==0) {?><a href="index.php?c=expect&e=<?php echo $_smarty_tpl->tpl_vars['resume']->value['id'];?>
#edu_upbox" class="member_index_resume_msg_a">+ 教育经历</a><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['resume']->value['training']==0) {?><a href="index.php?c=expect&e=<?php echo $_smarty_tpl->tpl_vars['resume']->value['id'];?>
#training_upbox" class="member_index_resume_msg_a">+ 培训经历</a><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['resume']->value['skill']==0) {?><a href="index.php?c=expect&e=<?php echo $_smarty_tpl->tpl_vars['resume']->value['id'];?>
#skill_upbox" class="member_index_resume_msg_a">+ 职业技能</a><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['resume']->value['project']==0) {?><a href="index.php?c=expect&e=<?php echo $_smarty_tpl->tpl_vars['resume']->value['id'];?>
#project_upbox" class="member_index_resume_msg_a">+ 项目经验</a><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['resume']->value['other']==0) {?><a href="index.php?c=expect&e=<?php echo $_smarty_tpl->tpl_vars['resume']->value['id'];?>
#other_upbox" class="member_index_resume_msg_a">+ 其他信息</a><?php }?>
                <?php if ($_smarty_tpl->tpl_vars['resume']->value['description']=='') {?><a href="index.php?c=expect&e=<?php echo $_smarty_tpl->tpl_vars['resume']->value['id'];?>
...
" class="member_index_no_resume_a">创建简历</a> </div>
    ...
    <div class="member_right_box member_right_box_bor  mt20 fltL">
    <div class="member_right_index_h1 fltL"><i class="member_right_h1_icon user_bg"></i>
        <span class="member_right_h1_span fltL">感兴趣的职位</span>
    </div>
...
" class="member_right_job_box_name cblue"><?php echo $_smarty_tpl->tpl_vars['blist']->value['name_n'];?>
              ...
              <span class="member_right_job_xz"><?php echo $_smarty_tpl->tpl_vars['blist']->value['job_salary'];?>
</span>
              <a><?php echo $_smarty_tpl->tpl_vars['blist']->value['com_n'];?>
</a>
          </li>
        <?php }
...
?>
        <div class="member_right_no_job">
          <div class="member_right_no_job_box ">
            <div class="member_right_no_jobl">！ </div>
            <div class="member_right_no_jobr" style="margin-top:30px; font-size:22px;"> 暂无推荐职位 </div>
          </div>
        </div>
        <?php } ?>
      </ul>
