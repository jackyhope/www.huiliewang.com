<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-07-05 18:04:24
         compiled from "/home/wwwroot/www.huiliewang.com/app/template/admin/admin_makenews.htm" */ ?>
<?php /*%%SmartyHeaderCode:18135248155b3ded28e353f2-33714525%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cd4bd4431a6d0b79f0b65d9a809b89c35491a11d' => 
    array (
      0 => '/home/wwwroot/www.huiliewang.com/app/template/admin/admin_makenews.htm',
      1 => 1517800850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18135248155b3ded28e353f2-33714525',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b3ded28ec53e5_84268496',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b3ded28ec53e5_84268496')) {function content_5b3ded28ec53e5_84268496($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
      ...
      <tr>
        ...
        <td>
          <div class="yun_admin_select_box">
            ...
            <input type="button" value="全部" class="yun_admin_select_box_text" id="once_name" onClick="select_click('once');">
            <input name="group" type="hidden" id="once_val" value="0">
        
            <div class="yun_admin_select_box_list_box dn" id="once_select">
...
?>
                 ...
                 <a href="javascript:;" onClick="select_new('once','<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
      ...
      <tr>
        ...
        <td>
         ...
         <div class="yun_admin_select_box">
            ...
            <input type="button" value="全部" class="yun_admin_select_box_text" id="group_name" onClick="select_click('group');">
            <input name="group" type="hidden" id="group_val" value="all">
        
            <div class="yun_admin_select_box_list_box dn" id="group_select">
                <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['rows']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['v']->key => $_smarty_tpl->tpl_vars['v']->value) {
$_smarty_tpl->tpl_vars['v']->_loop = true;
?>
                 <div class="yun_admin_select_box_list">
                 <a href="javascript:;" onClick="select_new('group','<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
')"><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
</a>
                 </div> 
      ...
      <tr class="admin_table_trbg">
        ...
        <td>
          ...
          <div class="yun_admin_select_box">
            ...
            <input type="button" value="全部" class="yun_admin_select_box_text" id="groupcont_name" onClick="select_click('groupcont');">
            <input name="group" type="hidden" id="groupcont_val" value="0">
        
            <div class="yun_admin_select_box_list_box dn" id="groupcont_select">
                <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['rows']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['v']->key => $_smarty_tpl->tpl_vars['v']->value) {
$_smarty_tpl->tpl_vars['v']->_loop = true;
?>
                 <div class="yun_admin_select_box_list">
                 <a href="javascript:;" onClick="select_new('groupcont','<?php echo $_smarty_tpl->tpl_vars['v']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
')"><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
</a>
                 </div> 
      ...
      <tr>
        <th>发布时间：</th>
        <td><input id="stime" class="admin_makenews_time" type="text" readonly size="21"  name="stime">
          -
          <input id="etime" class="admin_makenews_time" type="text" readonly size="21"  name="etime">
          <?php echo '<script'; ?>
