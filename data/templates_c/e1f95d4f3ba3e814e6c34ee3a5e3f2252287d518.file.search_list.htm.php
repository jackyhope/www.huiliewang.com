<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-10-08 09:41:18
         compiled from "/home/wwwroot/www.huiliewang.com/app/template/member/lietou/search_list.htm" */ ?>
<?php /*%%SmartyHeaderCode:5902040205bbab5be262b86-30578153%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e1f95d4f3ba3e814e6c34ee3a5e3f2252287d518' => 
    array (
      0 => '/home/wwwroot/www.huiliewang.com/app/template/member/lietou/search_list.htm',
      1 => 1519973910,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5902040205bbab5be262b86-30578153',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbab5be376a61_18662077',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbab5be376a61_18662077')) {function content_5bbab5be376a61_18662077($_smarty_tpl) {?><?php if (!is_callable('smarty_function_parse_url')) include '/home/wwwroot/www.huiliewang.com/app/include/libs/plugins/function.parse_url.php';
          ...
          <?php }?>
                  <div class="left_job_all fl">
                      <div class="tongji">
                          ...
                          <div class="paixu_btn">
                              <a class="pxbtn <?php if ($_GET['order']=='salary') {?>pxcur<?php }?>" href="<?php echo smarty_function_parse_url(array('m'=>'member','c'=>'resume','order'=>'salary'),$_smarty_tpl);?>
">年薪从高到低</a>
                              <a class="pxbtn <?php if ($_GET['order']=='time') {?>pxcur<?php }?>" href="<?php echo smarty_function_parse_url(array('m'=>'member','c'=>'resume','order'=>'time'),$_smarty_tpl);?>
">更新时间从新到旧</a>
                          </div>
                      </div>
                      <div class="job_left_sidebar" id="sscontent" style="width: 1040px;margin-left: 30px;">
...
?>
                          <div class="job_news_list  job_hr_list_box" style="width: 1030px;">
                              <div class="job_hr_resume_user" style="margin-top: 10px;width: 1040px;">
                                  <div style="width: 100%;">
                                      <a class="job_namer nowrap" style="font-size: 18px;vertical-align:bottom;max-width: 150px;" href="<?php echo $_smarty_tpl->tpl_vars['user']->value['user_url'];?>
" target="_blank"><?php if ($_smarty_tpl->tpl_vars['user']->value['name']) {
...
岁</label><span class="xianshu">|</span>
                                      ...
                                      <label class="btns_ji" style="float: right;margin-right: 20px;">
                                          <a  href="/member/index.php?c=resume&act=jobrecommend&eid=<?php echo $_smarty_tpl->tpl_vars['user']->value['id'];?>
...
/images/tuijian.png" class="ico_dd">
                                              <label class="biaoqian">推荐候选人</label>
                                          </a>
...
" data-eid="<?php echo $_smarty_tpl->tpl_vars['user']->value['eid'];?>
">取消收藏</label>-->
                                        <?php if ($_smarty_tpl->tpl_vars['user']->value['edit']) {?>
...
" target="_blank">编辑</a>
                                  ...
                                  <div class="fl" style="width: 40%;padding-right: 10px;margin-top: 20px;">
                                      <div class="job_hr_resume_user_name">
                                          <div class="mat_10">
                                              <?php if ($_smarty_tpl->tpl_vars['user']->value['resume_edu']) {?>
...
-<?php echo date('Y/m',$_smarty_tpl->tpl_vars['list']->value['endDateStr']);?>
                              ...
                              <div class="fl" style="margin-top: 20px;width: 100%;">
                                  <label class="tj_time">推荐的职位：
                                      <label style="font-size: 16px;color: #4b6e88;">PHP工程师</label><span class="xianshu color_999">|</span><label class="color_999" style="margin-right: 30px;">推荐时间：2018-12-23</label>
                                      <label style="font-size: 16px;color: #4b6e88;">PHP工程师</label><span class="xianshu color_999">|</span><label class="color_999" style="margin-right: 30px;">推荐时间：2018-12-23</label>
                                  </label>
                              </div>
                              <?php } else { ?>
...
/images/search-no.gif" width="144" height="102"/></div>
                              <div class="listno-content" style="line-height: 24px;"> <strong>很抱歉，暂时没有符合条件的人才信息</strong><br><br>
                                  <span>建议您尝试修改搜索条件进行搜索</span>
                              </div>
                          </div>
                          <?php }?> </div>
                  </div>
...
//    var nav=<?php echo $_GET['type'];?>
;
//        if(nav==1){
//            $(".Search_jobs_box").show();
//        }else{
//            $(".Search_jobs_box").hide();
//        }
    })
...
function SearchHighlight(idVal, keyword) {
    ...
    if("" == keyword || keyword.matches("[0-9]+")) return;
    ...
    document.ready=function () {
        SearchHighlight('sscontent',$("#keyword").val());
    }
