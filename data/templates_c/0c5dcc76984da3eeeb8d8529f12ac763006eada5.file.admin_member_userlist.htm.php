<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-06-12 17:39:28
         compiled from "/home/wwwroot/www.huiliewang.com/app/template/admin/admin_member_userlist.htm" */ ?>
<?php /*%%SmartyHeaderCode:15387660225b1f94d0c16f43-94710831%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c5dcc76984da3eeeb8d8529f12ac763006eada5' => 
    array (
      0 => '/home/wwwroot/www.huiliewang.com/app/template/admin/admin_member_userlist.htm',
      1 => 1517800850,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15387660225b1f94d0c16f43-94710831',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b1f94d0dd2d17_93359291',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b1f94d0dd2d17_93359291')) {function content_5b1f94d0dd2d17_93359291($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/wwwroot/www.huiliewang.com/app/include/libs/plugins/modifier.date_format.php';
...
<div id="info_div"  style="display:none; width: 350px; ">
  <div class="" style=" margin-top:10px; "  >
    <form action="index.php?m=user_member&c=ckstatus" target="supportiframe" method="post" id="formstatus">
      <table cellspacing='1' cellpadding='1' class="admin_examine_table">
     <tr>
    <th width="80">审核操作：</th>
     <td align="left">
         <label for="state0"> <span class="admin_examine_table_s"><input type="radio" name="status" value="0" id="state0" >未审核</span></label>
         <label for="state1"> <span class="admin_examine_table_s"><input type="radio" name="status" value="1" id="state1" >正常</span></label>
         <label for="state3"> <span class="admin_examine_table_s"><input type="radio" name="status" value="3" id="state3">未通过</span></label>
          </td>
        </tr>
        </tr>
          <tr>
...
">锁定</a><br/>
              <a href="javascript:;" class="admin_cz_sc check" pid="<?php echo $_smarty_tpl->tpl_vars['v']->value['uid'];?>
" status="<?php echo $_smarty_tpl->tpl_vars['v']->value['status'];?>
">审核</a> | <a href="index.php?m=user_member&c=edit&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['uid'];?>
