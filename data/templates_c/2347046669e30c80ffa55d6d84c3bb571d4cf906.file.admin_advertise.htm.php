...
);" ><?php if ($_smarty_tpl->tpl_vars['v']->value['is_end']=='1') {?><font color="red">已过期</font><?php } elseif ($_smarty_tpl->tpl_vars['v']->value['is_check']=="1") {?><font color="green">已审核</font><?php } else { ?><font color="EE6723">未审核</font><?php }?></a></td>
