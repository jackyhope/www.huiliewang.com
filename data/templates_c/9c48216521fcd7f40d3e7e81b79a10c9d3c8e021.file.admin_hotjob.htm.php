...
"/>
<span class="complay_top_span fl">名企管理</span>	
<div class="admin_Filter_span">搜索类型：</div>
      <div class="admin_Filter_text formselect" did="dctype">
        <input type="button" <?php if ($_GET['ctype']=='2') {?> value="备注" <?php } else { ?> value="企业名称" <?php }?> class="admin_Filter_but" id="bctype">
...
');" class="admin_cz_sc">修改</a> | <a href="javascript:void(0);" onClick="layer_del('确定要取消该名企？','index.php?m=admin_hotjob&c=del&id=<?php echo $_smarty_tpl->tpl_vars['v']->value['uid'];?>
