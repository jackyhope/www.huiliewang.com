<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-10-09 05:29:27
         compiled from "/home/wwwroot/www.huiliewang.com/app/template/default/register/user.htm" */ ?>
<?php /*%%SmartyHeaderCode:11945549465bbbcc37a29ae4-93218469%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '72e30c77f9e82aca01b36c6ec6d7bb1b71e1f19b' => 
    array (
      0 => '/home/wwwroot/www.huiliewang.com/app/template/default/register/user.htm',
      1 => 1526538598,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11945549465bbbcc37a29ae4-93218469',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbbcc37b99029_43040996',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbbcc37b99029_43040996')) {function content_5bbbcc37b99029_43040996($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/home/wwwroot/www.huiliewang.com/app/include/libs/plugins/function.url.php';
...
"><i class="reg_h1_icon_i reg_h1_icon_i5 png"></i>猎头注册</a></li>-->
          <li class="<?php if ($_smarty_tpl->tpl_vars['type']->value==2) {?>reg_cur<?php }?>"><a class="reg_h1_icon" href="<?php echo smarty_function_url(array('m'=>'register','usertype'=>2,'type'=>1),$_smarty_tpl);?>
...
用户服务协议》</a> ，并自愿遵守该协议。</label>
         ...
         <li class="mt20">
             <em>&nbsp;</em><input type="button" class="register_submit" value="立即注册" onclick="check_user(2,'vcode_img');"/>
...
用户服务协议》</a> ，并自愿遵守该协议。</label>
         ...
         <li class="mt20">
             <em>&nbsp;</em><input type="button" class="register_submit" <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_real_name_check']=='0') {?> id='subreg' <?php }?> value="立即注册" onclick="check_user(3,'vcodeimg');"/>
             <label  class="register_submit lablebeizhu"> 已有账号，<a class="linkbtn" href="<?php echo smarty_function_url(array('m'=>'login'),$_smarty_tpl);?>
">立即登录</a> </label>
     ...
     <ul class="register_list">
         <li class="mt20">
             <label style="margin-left: 280px;color: #333;font-size: 18px;">求职者账号注册</label>
         </li>
...
用户服务协议》</a> ，并自愿遵守该协议。
         ...
         <li class="mt20">
             <em>&nbsp;</em><input type="button" class="register_submit" <?php if ($_smarty_tpl->tpl_vars['config']->value['reg_real_name_check']=='0') {?> id="subreg" <?php }?> value="立即注册" onclick="check_user('1','vcode_imgs');"/>
             <label  class="register_submit lablebeizhu"> 已有账号，<a class="linkbtn" href="<?php echo smarty_function_url(array('m'=>'login'),$_smarty_tpl);?>
">立即登录</a> </label>
...
">注册企业账户</a></div>-->
        ...
        <div class="register_right_c">
            <a href="/index.php?m=register&usertype=2&type=1" class="btnsitem" style="background: #f26d49;">我是企业HR，注册企业账号>></a>
        </div>
