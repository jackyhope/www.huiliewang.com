<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-10-07 17:13:47
         compiled from "/home/wwwroot/www.huiliewang.com/app/template/default/job/comapply.htm" */ ?>
<?php /*%%SmartyHeaderCode:1086237015bb9ce4b44a2a9-95981818%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '85d74583d4aa60e2fd3fddb13aad8c2f8cadae08' => 
    array (
      0 => '/home/wwwroot/www.huiliewang.com/app/template/default/job/comapply.htm',
      1 => 1519270974,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1086237015bb9ce4b44a2a9-95981818',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bb9ce4bbb4ef6_28492180',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bb9ce4bbb4ef6_28492180')) {function content_5bb9ce4bbb4ef6_28492180($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/home/wwwroot/www.huiliewang.com/app/include/libs/plugins/function.url.php';
...
<?php } else { ?>
    ...
    <div class="current_Location png" style="width: 1200px;margin: 0 auto;"> 您当前的位置：<a href="<?php echo $_smarty_tpl->tpl_vars['config']->value['sy_weburl'];?>
		...
		<?php if ($_smarty_tpl->tpl_vars['usertype']->value==1) {?>
			...
			<?php }?>
              ...
              <?php } elseif ($_smarty_tpl->tpl_vars['usertype']->value==3) {?>
                <a id="tujianhxr" href="member/index.php?c=recommend&id=<?php echo $_smarty_tpl->tpl_vars['Info']->value['id'];?>
" target="_blank">推荐候选人</a>
                <div id="gzzhiwei">+关注</div>
              <?php }?>
...
" class="Company_post_sub_a Company_post_sub_a_sc" rel="nofollow">收藏</a>
			<?php }?>
          <a style="display: none;" href="<?php echo smarty_function_url(array('m'=>'job','c'=>'recommend','id'=>$_smarty_tpl->tpl_vars['Info']->value['id']),$_smarty_tpl);?>
...
/images/tubiaoqi.png" class="ico_zwdt"/>
          <ul class="tj_items">
              <li class="tjnubs">
                  <div class="hang1"><label class="numdd">12</label>位</div>
                  <div class="hang2">服务猎头</div>
              </li>
              <li class="tjnubs">
                  <div class="hang1"><label class="numdd">12</label>人</div>
                  <div class="hang2">候选人</div>
              </li>
              <li class="tjnubs">
                  <div class="hang1"><label class="numdd">12</label>份</div>
      ...
      <div class="Company_Basic_information">
          <div class="Company_Basic_information_list"> <i class="Company_Basic_information_icon comany_ico"></i>
              <div class="Company_Basic_information_r">
                  ...
                  <?php if ($_smarty_tpl->tpl_vars['Info']->value['com_name']) {?><span class="Company_Basic_information_l"><?php echo mb_substr($_smarty_tpl->tpl_vars['Info']->value['com_name'],0,13,'gbk');?>
</span><?php }?>
                  </div>
          </div>
...
月</span></label>
   ...
   <?php if ($_smarty_tpl->tpl_vars['Info']->value['identity']!=3) {?>
    <div class="job_hr" style="border: none;">
    <!--<div class="job_hr_tit">职位发布者</div>-->
    <!--<div class="job_hr_icon">HR</div>-->
    <div class="job_hr_left" style="display: none;">
...
/app/include/authcode.inc.php" onclick="checkCode('vcode_imgs');"/>
    ...
    <div class="job_hr_right" style="display: none;">
...
?>
        <li>
         <div class="comappiy_left_jobname">
...
"><?php echo $_smarty_tpl->tpl_vars['keylist']->value['key_name'];?>
  ...
  <div class="Compply_right_sidebar">
    <div class="Compply_right_qy" style="position: relative;">
...
万</span></li>
        ...
        <div class="Compply_right_js">
            <ul>
                <li style="margin-left: 10px;">企业招聘职位数：<a class="nubers" href="#">5</a></li>
                <li style="margin-left: 10px;">简历及时处理率：<label class="nubers">100%</label></li>
                <li style="margin-left: 10px;">企业最近登录：<label class="nubers">2018-12-22</label></li>
            </ul>
        </div>
        <?php }?>
    </div>
        ...
        <div class="Compply_right_post" style="margin-top: 20px;">
            ...
            <a class="img_tx" style="display: block;" href="/lietou">
