...
<div class="infoboxp">
  ...
  <div class="infoboxp_top" style="z-index:600;position:relative;">
    <div class="report_uaer_list"> 
    	...
    	<a href="index.php?m=report" <?php if ($_smarty_tpl->tpl_vars['type']->value!='1'&&$_smarty_tpl->tpl_vars['type']->value!='2'&&$_smarty_tpl->tpl_vars['ut']->value!='2') {?> class="report_uaer_list_on"<?php }?>>被举报职位</a> 
    	<a href="index.php?m=report&ut=2" <?php if ($_smarty_tpl->tpl_vars['ut']->value=='2') {?> class="report_uaer_list_on"<?php }?>>被举报简历</a> 
    	<a href="index.php?m=report&type=1" <?php if ($_smarty_tpl->tpl_vars['type']->value=='1') {?> class="report_uaer_list_on"<?php }?>>被举报问答</a> 
    	<a href="index.php?m=report&type=2" <?php if ($_smarty_tpl->tpl_vars['type']->value=='2') {?> class="report_uaer_list_on"<?php }?>>被投诉顾问</a> 
    </div>
  </div>
...
&eid=<?php echo $_smarty_tpl->tpl_vars['user']->value['eid'];?>
');"class="admin_cz_sc">删除职位</a> <?php }?> | <a  href="javascript:void(0)" onclick="resultreport('<?php echo $_smarty_tpl->tpl_vars['user']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['user']->value['result'];?>
')"  class="admin_cz_sc">处理结果</a> | <a href="javascript:void(0)" onClick="layer_del('确定要删除？', 'index.php?m=report&c=del&del=<?php echo $_smarty_tpl->tpl_vars['user']->value['id'];?>
...
');" class="admin_cz_sc">删除</a> | <a href="javascript:void(0)" onclick="resultreport('<?php echo $_smarty_tpl->tpl_vars['r']->value['id'];?>
','<?php echo $_smarty_tpl->tpl_vars['r']->value['result'];?>
