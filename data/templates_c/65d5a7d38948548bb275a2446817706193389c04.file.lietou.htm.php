<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-10-08 09:36:03
         compiled from "/home/wwwroot/www.huiliewang.com/app/template/default/register/lietou.htm" */ ?>
<?php /*%%SmartyHeaderCode:9065132695bbab4833cdae5-84760786%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '65d5a7d38948548bb275a2446817706193389c04' => 
    array (
      0 => '/home/wwwroot/www.huiliewang.com/app/template/default/register/lietou.htm',
      1 => 1517800852,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9065132695bbab4833cdae5-84760786',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5bbab48352b402_61261033',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5bbab48352b402_61261033')) {function content_5bbab48352b402_61261033($_smarty_tpl) {?><?php if (!is_callable('smarty_function_url')) include '/home/wwwroot/www.huiliewang.com/app/include/libs/plugins/function.url.php';
  ...
  <div class="logoin_cont fl">
    <div class="reg_h1_tit">
      <ul class="reg_ul_list">
          <li class="<?php if ($_smarty_tpl->tpl_vars['type']->value==1) {?>reg_cur<?php }?>"><a class="reg_h1_icon" href="<?php echo smarty_function_url(array('m'=>'register','usertype'=>3,'type'=>1),$_smarty_tpl);?>
"><i class="reg_h1_icon_i reg_h1_icon_i5 png"></i>猎头注册</a></li>
          <li class="<?php if ($_smarty_tpl->tpl_vars['type']->value==3) {?>reg_cur<?php }?>"><a class="reg_h1_icon" href="<?php echo smarty_function_url(array('m'=>'register','usertype'=>2,'type'=>1),$_smarty_tpl);?>
     ...
     <li><em>&nbsp;</em>
       ...
       <div class="kg_lgn_psw_txt">密码强度:</div>
		...
		<?php } else { ?>
			...
			<em><font color="#FF0000">*</font> 验证码1：</em>
          <input id="CheckCode" type="text" class="logoin_text_yz" onBlur="reg_checkAjax('CheckCode');" maxlength="4"/>
...
用户服务协议》</a> ，并自愿遵守该协议。</label>
     ...
     <ul class="register_list">
         <li class="mt20">
             <label style="margin-left: 280px;color: #333;font-size: 18px;">猎头账号注册</label>
         </li>
...
">注册个人账户</a></div>-->
      <div class="register_right_c">
          <a href="/index.php?m=register&usertype=2&type=1" class="btnsitem" style="background: #4e5c84">我是企业HR，注册企业账号>></a>
      </div>
        <div class="register_right_c">
